...
工程师的核心技能会从“怎么问 AI 一个好问题”，转向“怎么设计一个系统，让系统持续问对问题、做对事情、验收结果”。

<CardGrid>
  <Card title="设计循环" icon="random">
    定义目标、触发条件、工具权限、验证标准、重试策略和退出条件。
  </Card>
  <Card title="训练系统" icon="star">
    把错误经验、业务规则、项目规范沉淀到 Skills、规则和长期记忆里。
  </Card>
  <Card title="验证产出" icon="approve-check">
    不能只看 Agent 的总结，要用测试、日志、业务状态和独立 Checker 做客观验收。
  </Card>
</CardGrid>
